...
console.log('window啊啊啊啊啊', window.__POWERED_BY_QIANKUN__)
const router = new Router({
  base: window.__POWERED_BY_QIANKUN__ ? '/datum' : '/',
  routes: permissionSwitch ? generateRoleRouters(flatAuthMenu, flatData(routes)) : routes,
  mode: 'history',
})
